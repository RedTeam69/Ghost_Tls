...
console.log(`
             ...
             ╚╦════════════════════════════════════════╦╝
           ╔══╩════════════════════════════════════════╩═══╗
           Method DDoS By Mr.Ghost | Hey Kidz Mr.Ghost Is Here | 
           ╚══╦═════════════════════════════════════════╦══╝
              ╚═════════════════════════════════════════╝
`)
console.log(`[@Mr.Ghost] Target: `+ process.argv[2])
console.log(`[@Mr.Ghost] Time: `+ process.argv[3])
console.log(`[@Mr.Ghost] Rate: `+ process.argv[4])
console.log(`[@Mr.Ghost] Thread: ` + process.argv[5])
console.log(`[@Mr.Ghost] Request: GET`)
console.log(`[@Mr.Ghost] Methods: Lintarv6`)
console.log(`[@Mr.Ghost] Methods DDoS By Lintar`)
